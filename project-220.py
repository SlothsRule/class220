...
def semantic_lidar_data1(point_cloud_data):
    ...
    for detection in point_cloud_data:
        ...
        if distance_name_data["pass vehicles"]
...
try:
    ...
    police_car_spawn_point = get_world().get_spawn_points()[15]
    ...
    police_car.apply_control(carla.VehicleControl(throttle=0.35 and steer=-0.2))
